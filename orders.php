...
<div class="container-fluid">
  ...
  <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3" style="background-color:#777777;box-shadow: 0 4px 18px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.4); width:50%;">
      <div class="page-header">
        <center><h2 style="font-weight:bold; color:white;">Create New Order</h2></center>
      </div>
    <form action="orders.php" method="post" class="form-horizontal">

      <div class="form-group">
          <label for="productid" class="col-sm-3 control-label" style="font-weight:bold; color:white;">Order ID</label>
          <div class="col-sm-9">
        ...
        <div class="form-group">
          <label for="productid" class="col-sm-3 control-label" style="font-weight:bold; color:white;">Order Date</label>
          <div class="col-sm-9">
      <input name="orderdate" class="form-control" id="orderdate" placeholder="Order Date"  type="text" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; ?>"> 
    </div>
  </div>

  <div class="form-group">
          <label for="sid" class="col-sm-3 control-label" style="font-weight:bold; color:white;">Staff Name</label>
          <div class="col-sm-9">
      ...
      ?> 
        ...
        <div class="form-group">
          <label for="cid" class="col-sm-3 control-label" style="font-weight:bold; color:white;">Customer Name</label>
          <div class="col-sm-9">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a173616, tbl_staffs_a173616_pt2, tbl_customers_a173616_pt2 WHERE ";
        $sql = $sql."tbl_orders_a173616.fld_staff_id = tbl_staffs_a173616_pt2.fld_staff_id and ";
        $sql = $sql."tbl_orders_a173616.fld_customer_id = tbl_customers_a173616_pt2.fld_customer_id LIMIT $start_from, $per_page";
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      <ul class="pagination" style="box-shadow: 0 4px 18px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.2);">
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a173616");
            $stmt->execute();
            $result = $stmt->fetchAll();
