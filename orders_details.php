...
<head>
  <meta charset="utf-8">
    ...
    <title>Gym Hope : Order Details</title>
  <!-- Bootstrap -->
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a173616, tbl_staffs_a173616_pt2,
          tbl_customers_a173616_pt2 WHERE
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="panel panel-default" style="box-shadow: 0 4px 18px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.2);">
  ...
  <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3" style="background-color:#777777;box-shadow: 0 4px 18px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.4); width:50%;">
      <div class="page-header">
       <center><h2 style="font-weight:bold; color:white">Add a Product</h2></center> 
      </div>
      <form action="orders_details.php" method="post" class="form-horizontal" name="frmorder" id="forder">
      <div class="form-group">
          <label for="prd" class="col-sm-3 control-label" style="font-weight:bold; color:white;">Product</label>
          <div class="col-sm-9">
      ...
      <div class="form-group">
          <label for="qty" class="col-sm-3 control-label" style="font-weight:bold; color:white;">Quantity</label>
          <div class="col-sm-9">
            <input name="quantity" type="number" class="form-control" placeholder="Product Quantity" id="qty" min="1" required>
          </div>
      </div>
      <div class="form-group">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <a style="background-color:#000000"  href="invoice.php?oid=<?php echo $_GET['oid']; ?>" target="_blank" role="button" class="btn btn-primary btn-lg btn-block">Generate Invoice</a>
    </div>
  </div>
  <br>
</div>
